...
def build_membership_features(
    ...
    membership_agg["days_since_last_membership_end"] = days_between(
    ...
    membership_agg["days_since_last_membership_end"] = clip_days(
        membership_agg["days_since_last_membership_end"],
        365,
    )
...
def build_complaint_features(
    ...
    c["created_at_utc"] = to_utc(c["created_at_utc"])
    c["resolved_at_utc"] = to_utc(c["resolved_at_utc"])
    ...
    complaint_agg["complaint_reporter_last_at"] = to_utc(complaint_agg["complaint_reporter_last_at"])
    complaint_agg["complaint_target_last_at"] = to_utc(complaint_agg["complaint_target_last_at"])
